...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        for word in self.get_message_text().split(' '):
            for letter in word:
                shifted_message.append(shift_dict[letter])
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            for word in self.message_text.split(' '):
                new_shift = 26 - shift
                shift_dict = self.build_shift_dict(new_shift)
                new_word = self.apply_shift(new_shift)

                if is_word(words, word):
                    valid_words.append((new_shift, new_word))
